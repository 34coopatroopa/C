...
void how_many_whole_digits(int number)
{
    ...
    {
        printf("8 digits\n");
    } else if ((int) number / 1000000 != 0)
    {
        printf("7 digits\n");
    } else if ((int) number / 100000 != 0)
    {
        printf("6 digits\n");
    } else if ((int) number / 10000 != 0)
    {
        printf("5 digits\n");
    } else if ((int) number / 1000 != 0)
    {
        printf("4 digits\n");
    } else if ((int) number / 100 != 0)
    {
        printf("3 digits\n");
    } else if ((int) number / 10 != 0)
    {
        printf("2 digits\n");
    } else if ((int) number / 1 != 0)
    {
        printf("1 digit\n");
    }
}
